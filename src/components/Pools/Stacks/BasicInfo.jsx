...
export default class BasicInfo extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      name: props.stack.current.data.name,
      description: props.stack.current.data.description,
    };
  }
  ...
  handleNameEditClick = (e) => {
    ...
    this.setState({
      name: this.props.stack.current.data.name,
      nameEditing: true,
    });
  };
  ...
  handleNameSaveClick = (e) => {
    ...
    this.props.updateStack(current);
  ...
  handleDescriptionEditClick = (e) => {
    ...
    this.setState({
      description: this.props.stack.current.data.description,
  ...
  renderBasicInfo() {
    const prop = this.props.stack.current.data;
    ...
    return (
      <div className="rowHeight">
        ...
        <Row>
          ...
          <Col span="10">
            <span className="content">{prop.updatedAt}</span>
          </Col>
        </Row>
        <Row>
          <Col span="2">
  ...
  render() {
    const basic = this.props.stack.current;
